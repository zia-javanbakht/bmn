...
% ══════════════════════════════════════════════════════════════════════════════════════════════════
	...
	% horizontal line
%	\addplot[samples=10, very thin, blue, domain=17:22] {100.06};


\addplot
[%mark=x, only marks,
%mark options={red,fill=white},
no marks, densely dashed, semithick, smooth,
mark size=1.5pt,
error bars/.cd,
y dir=both,
y explicit,
...
error mark options={rotate=90, blue, mark size=1pt, line width=0.5pt}
 ...
 x index=0, 
 y index=1,x expr=\thisrowno{0}*100
% ,y error index=2
 ] 
 {./_data_ch8/experimental_data.tex};
...
error bars/.cd,
	y dir=both,
	y explicit,
	error bar style={gray, line width=0.5pt},
	error mark options={rotate=90, gray, mark size=1pt, line width=0.5pt}
] table [
 x index=0, 
 y index=1, 
 x expr=\thisrowno{0}*100
 ] 
 {./_data_ch8/fea_without.tex};
%
%
%\addplot
%[name path=kellyc,
...
%
%\addplot
%[name path=kellyen,densely dashdotted,
%mark=diamond*,
%	mark options={fill=white},
%	no marks, 
%mark size=\the\marksize,
...
%  \addlegendentry{FE wo};
  \addlegendentry{\footnotesize Experimental (samples)};
  \addlegendentry{\footnotesize Computational ($+$)};
  \addlegendentry{\footnotesize Computational ($-$)};
%  \addlegendentry{Classic Kelly-Tyson model};
%  \addlegendentry{Enhanced Kelly-Tyson model};
