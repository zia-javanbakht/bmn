...
%smooth
 ...
 \begin{tikzpicture}
      ...
      x=4cm,
      ybar=0.2cm,
      ylabel=Eigenvalue of the orientation tensor ($\lambda_{\text{max/min}}$),
      bar width=12pt,
      ymajorgrids = true,
      symbolic x coords={{$\lambda_{\rm max}$},{$\lambda_{\rm min}$}},
      xtick = data,
      ...
      y explicit
          ...
          coordinates 
          {
          ({$\lambda_{\rm max}$}, 0.547
          ) +- (0,0.013
          ) 
          ({$\lambda_{\rm min}$}, 0.453
          ) +- (0,0.013
          ) 
          };
     \addplot[style={fill=black!20, postaction={pattern=dots}},error bars/.cd, y dir=both, y explicit,error bar style=black,      error bar style={line width=1pt},
           ...
           coordinates {
          ({$\lambda_{\rm max}$}, 0.535
          ) +- (0,0.0197
          ) 
          ({$\lambda_{\rm min}$}, 0.471
          ) +- (0,0.0197
          ) 
          };
      ...
      \addplot[style={fill=black!60, postaction={pattern=grid}},error bars/.cd, y dir=both, y explicit,error bar style=black,      error bar style={line width=1.pt},
           ...
           coordinates {
          ({$\lambda_{\rm max}$}, 0.531
          ) +- (0,0.009
          ) 
          ({$\lambda_{\rm min}$}, 0.487
          ) +- (0,0.009
          ) 
          };
