...
\begin{tikzpicture}%[width=0.3\textwidth]
	  \coordinate (C) at (0cm,2.5cm);
%	  \draw [black,very thick, rotate around={41:(C)}] (C) ellipse (0.52446 and 0.47554);
	  \draw [black,very thick, rotate around={58:(C)}] (C) ellipse (0.54 and 0.46);
	  \draw[very thin,-{>[scale=1.5,length=6, width=3]},rotate around={58.3:(C)}] ($(C)+(-1.5,0cm)$) -- ($(C)+(+1.5,0cm)$);
	  \draw[very thin,-{>[scale=1.5,length=6, width=3]},rotate around={58.3:(C)}] ($(C)+(0,-1.5cm)$) -- ($(C)+(0,+1.5cm)$);
