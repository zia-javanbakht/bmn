...
height=7cm,
width=9cm,
xlabel = {Measure of concentration, $\kappa$},
xmin = -5,
xmax = 55,
%point meta=explicit symbolic,
ylabel =  {Principal rotation, $\vartheta^\prime\,(\text{deg})$},
%ymax = 1.8,
%ymin = 1.2,
%ytick={1.3,1.4,1.5,1.57,1.6,1.7},
%ytick pos=left,
...
error mark options={rotate=90, black, mark size=1pt, line width=0.5pt}
 ...
 {./_data_hc2/thetadata0.4.txt};
   \addlegendentry{\hspace{-0.7cm}$\zeta_\text{f}$};
   \addlegendentry{0.1};
   \addlegendentry{0.2};
   \addlegendentry{0.3};
   \addlegendentry{0.4};
%\addplot [very thin, gray ] coordinates {(-4.,1.57) (100,1.57)};
\end{axis}
\end{tikzpicture}
\end{document}