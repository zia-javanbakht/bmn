...
%ymax=50,
%ytick = {20,25,...,50},
extra y ticks={0.3186},
extra y tick style={
    yticklabel style={font=\small,yshift=0cm}
},
%ymin = 0,
%ytick pos=left,
...
% ══════════════════════════════════════════════════════════════════════════════════════════════════
	...
	% horizontal line
	\addplot[samples=10, thick, domain=0:450, dotted] {0.3186};
...
% \node at (3,0.21513) {0.21513};
 ...
 \begin{pgfonlayer}{axis foreground}
	% annotation
	\draw[thin,arrows={Stealth[length=2.5mm,fill=white]-}] (axis cs: 400,0.3188) -- +(0,10) node [above, anchor=south east] {\small $\text{Percentage relative Error}\le 0.05\%$};
 \end{pgfonlayer}
