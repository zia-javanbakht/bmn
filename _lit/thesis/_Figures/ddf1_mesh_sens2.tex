...
width = 12cm,
height = 8cm,
xlabel = {Mesh density (nm$^{-1}$), $\gamma$},
xmin = 0.0,
xmax = 4.5,
...
ylabel =  {Effective thermal conductivity ($\sfrac{\text{W}}{\text{m}\cdot\text{K}}$), $k$},
ymax = 0.2500, 
extra y ticks={0.2151},
extra y tick style={yticklabel style={font=\small}},
%ymin = 0,
%ytick pos=left,
...
% ══════════════════════════════════════════════════════════════════════════════════════════════════
	...
	% horizontal line
	\addplot[samples=10, thick, domain=0:5, dotted] {0.2151};
...
\addplot
[mark=*, no marks, dashed, thin, smooth,
mark options={black,fill=white,draw},
mark size=3pt,
error bars/.cd,
y dir=both,
y explicit,
...
% \node at (3,0.21513) {0.21513};
 ...
 \begin{pgfonlayer}{axis foreground}
	% annotation
	\draw[thin,arrows={Stealth[length=2.5mm,fill=white]-}] (axis cs: 3,0.216) -- +(0.5,10) node [above] {\small $\text{Percentage relative Error}\le 0.05\%$};
 \end{pgfonlayer}
