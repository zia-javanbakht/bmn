...
\begin{document}
 \begin{tikzpicture}[]
  \datavisualization [scientific axes,
    ...
    x axis = {length=7.5cm,ticks={step=0.1},label={$\zeta_{\text l}$}},
    y axis = {include value=0.4,length=5.5cm,ticks={step=0.01,style={/pgf/number format/fixed=4,/pgf/number format/precision=4}, minor steps between steps=1}, label={$k_{\text{eff}}$ ($\frac{\text{W}}{\text{m}\cdot\text{K}}$)}},
