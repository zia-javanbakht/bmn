...
ylabel =  {Total heat flux ($\times 10^3 \text{W}$), $\dot{Q}$},
ymax = 500, 
extra y ticks={430.25523},
%ymin = 0,
%ytick pos=left,
...
% ══════════════════════════════════════════════════════════════════════════════════════════════════
	...
	% horizontal line
	\addplot[samples=10, thick, domain=0:5,densely dotted] {430.25523};
...
% ,y error index=2
 ...
 {./_data_ddf1/flux_cond.tex};
 
% \node at (3,0.21513) {0.21513};
 \draw[Stealth-] (axis cs: 3,432) -- +(0.5,10) node [above] {\small $\text{Percentage relative Error}\le 0.05\%$};
