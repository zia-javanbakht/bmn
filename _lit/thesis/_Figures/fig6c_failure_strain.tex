...
ylabel =  {Failure strain (\%), $\varepsilon^\prime$},
ymax = 1.5,
ymin = 1.,
%ytick pos=left,
...
% ══════════════════════════════════════════════════════════════════════════════════════════════════
	...
	% horizontal line (plate value)
	\addplot[samples=10, very thin,  domain=17:22] {1.302};
...
y explicit,
 ...
 ,y error index=2
,y expr=\thisrowno{1}%*100
,y error expr=\thisrowno{2}%*100
 ] 
 {./_data_ch8/failstrain_updating.tex};
...
,y error expr=\thisrowno{2}%*100 
 ...
 {./_data_ch8/failstrain_not_updating.tex};
...
%  \addlegendentry{Kelly-Tyson model + FACF};
%  \addlegendentry{RoM};
