...
%mark size=3pt, name path=htl, dashdotted,
%error bars/.cd,
%y dir=both,
%y explicit,
...
%% ,y error index=2
% ] 
% {./_data_ddf3/bound_axial_L.tex};
%% Experimental (samples)
%\addplot
%[%mark=*, %only marks,
%%mark options={black,fill=white},
%mark size=3pt, name path=htu,
%error bars/.cd,
%y dir=both,
%y explicit,
%error bar style={black, line width=0.5pt},
...
% ,y error index=2
 ...
 {./_data_hc2/hc2_HT_axial.tex};
%\addplot
%[%mark=*, %only marks,
%%mark options={black,fill=white},
%mark size=3pt,  dashed,
%error bars/.cd,
%y dir=both,
%y explicit, 
%error bar style={black, line width=0.5pt},
...
%% ,y error index=2
% ] 
% {./_data_hc2/hc2_HT_trans.tex};
 
 
 
 
\addplot
[mark=*, densely dashdotted,%only marks,
...
%  ,y error index=2
%  ] 
%  {./_data_ddf3/E_strength_updating.tex};
%  
%
%	 
%
...
%
%	% CLassic IRoM-RoM
%	\addplot[opacity=0.2, gray!50, pattern=crosshatch] fill between [of=htl and htu]; 
%	
%	% RoM-En-RoM
...
% Legends
  ...
  \addlegendentry{2D Hatta-Taya (axial)};
%  \addlegendentry{2D Hatta-Taya (transverse)};
  \addlegendentry{Computational (mean)};
  \addlegendentry{Experiment (Choy et al 1997)};
%  \addlegendentry{\footnotesize Experimental (samples)};
%  \addlegendentry{\footnotesize Computational ($+/-$)};
%%  \addlegendentry{\footnotesize Computational ($+$)};
%  \addlegendentry{\footnotesize IRoM};
%  \addlegendentry{\footnotesize En-RoM};
%  \addlegendentry{\footnotesize Classic IRoM-RoM};
%  \addlegendentry{\footnotesize Extension by En-RoM};
\end{axis}
