...
ylabel =  {Normalised effective thermal conductivity, ($\sfrac{k_\text{eff}}{k_\text{m}}$)},
ymin =20, 
ymax=50,
ytick = {20,25,...,50},
extra y ticks={28.98},
extra y tick style={
    yticklabel style={font=\small,yshift=-0.1cm}
},
%ymin = 0,
%ytick pos=left,
...
% ══════════════════════════════════════════════════════════════════════════════════════════════════
	...
	% horizontal line
	\addplot[samples=10, thick, domain=0:35, dotted] {28.98211};
...
\addplot
[no marks, dashed, thin, smooth,
] table [
 x index=0, 
 y index=1
% ,y error index=2
 ] 
 {./_data_ddf3/mesh_sens.tex};
...
% \node at (3,0.21513) {0.21513};
 ...
 \begin{pgfonlayer}{axis foreground}
	% annotation
	\draw[thin,arrows={Stealth[length=2.5mm,fill=white]-}] (axis cs: 20,27.5) -- +(0,80) node [above] {\small $\text{Percentage relative Error}\le 0.12\%$};
 \end{pgfonlayer}
