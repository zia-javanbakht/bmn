...
% ══════════════════════════════════════════════════════════════════════════════════════════════════
	...
	% horizontal line
%	\addplot[samples=10, very thin, domain=17:22] {8190};


\addplot
[mark=*, smooth, no marks, densely dashed,
...
% ,y error index=2
 ...
 {./E.tex};
\addplot[mark=*, smooth, only marks,
mark options={black,fill=white},
mark size=1.5pt, thin,
error bars/.cd,
y dir=both,
y explicit,
error bar style={black, line width=0.5pt},
...
% Legends
  ...
  %\addlegendentry{Experimental (averaged plate value)};
