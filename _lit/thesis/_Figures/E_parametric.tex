...
xmin = 0,
minor ytick={7500,8500},
ytick = {7000,8000,9000},
extra y ticks = {8190,9382},
%extra y tick labels={8190,9382},
extra y tick style={
    yticklabel style={font=\small}
},
xmax = 21,
%point meta=explicit symbolic,
ylabel =  {Effective elastic modulus (MPa), $E_1$},
ymax = 9.7e3,
ymin = 7.e3,
width=7cm,
%ytick pos=left,
...
%legend columns=-1,
legend style={/tikz/every even row/.append style={row sep=-0.15cm},
},
...
% ══════════════════════════════════════════════════════════════════════════════════════════════════
	...
	% horizontal line
	\addplot[name path=test,samples=10, thin, densely dotted,black, domain=0:22] {8190};
	\draw[densely dotted] (axis cs: 17.79,0) -- +(0,9900);
%	\addplot[name path=testp,samples=10, domain=0:22, dashed] {8858};
%	\addplot[name path=testm,samples=10, domain=0:22, dashed] {7522};
%	\addplot[name path=rom,samples=10, domain=0:22, dashed] {7417.2};


\addplot
[mark=*, smooth, densely dashed, very thin, only marks,
mark options={black,fill=white, solid},
mark size=1.5pt,
error bars/.cd,
y dir=both,
y explicit,
error bar style={black, solid, line width=0.5pt},
error mark options={solid,rotate=90, mark size=1pt, line width=0.5pt},
] table [
 x index=0, 
 y index=1
 ,y error index=2
 ] 
 {./E_parametric_data.tex};
 
\addplot [domain=0:20.5, dashed,thin, gray] {-4.0941*x*x + 5.0258*x + 8951};


\addplot[name path=rom,samples=10, domain=0:22, only marks, mark=triangle*,mark options={black,fill=white, solid}] table [
	 x index=0, 
	 y index=1] {E_Krenchel_data.tex};

\addplot [domain=0:21, dashdotted, thin] {9382.54};

\addlegendentry{Experiment}
\addlegendentry{Local (FE)}
\addlegendimage{}
\addlegendentry{}
\addlegendentry{Global (Krenchel)}
\addlegendentry{}
...
% ,y error index=2
% ] 
% {./data/E_strength_updating.tex};


%	\addplot[opacity=0.75, gray!50] fill between [of=rom and enrom]; 
